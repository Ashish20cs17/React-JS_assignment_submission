...
import ashishPhoto from "./assets/ashish.jpg";
...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-sky-100 gap-6">
...
/>
              <div>
                <p className="font-bold text-gray-800">Ashish Kumar</p>
                <p className="text-gray-600 text-sm">aak479900@gmail.com</p>
              </div>
            </div>

            <p className="text-gray-600 text-sm leading-relaxed">
           This project submission is through Ashish Kumar
            </p>
          </div>
        )}
